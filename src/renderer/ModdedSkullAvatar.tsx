...
interface Props { mode: CompanionState; energy: number; tracking: TrackingPose; mouth: MouthShape; appearance: Appearance; onEyesClick?: () => void; }
