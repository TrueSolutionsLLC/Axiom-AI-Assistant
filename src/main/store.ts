...
export class AppStore {
  ...
  init(): void {
    ...
    this.data.connectors=Array.isArray(this.data.connectors)?this.data.connectors.filter((item)=>['google','shopify','meta','dropbox','homebridge','ring'].includes(item.id)).slice(-6):[];
